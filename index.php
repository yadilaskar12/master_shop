...
session_start();
require 'pelapak.php';
// if (isset($_COOKIE["login_ingat_saya"])) {

//   if ($_COOKIE["login_ingat_saya"]=='true') {
...
// $jenis_barang_kategori=["kosmetik,","alatangga","hardwarkomputer","elektronik","fashion"];

// $slide= mysqli_query($koneksi,"SELECT * FROM barang") or die (mysqli_error($koneksi));
// ;
...
$pembagi_data=ceil($jumlah_data / $jumlahHalaman); //floor
$data_aktif=(isset($_GET["halaman"])) ? $_GET["halaman"]:1;
$awal_data=($jumlahHalaman * $data_aktif) - $jumlahHalaman;

$result= mysqli_query($koneksi,"SELECT jenis_barang,nama_barang,diskon,harga_barang,deskripsi_barang,id_tambah,gambar FROM barang LIMIT $awal_data,$jumlahHalaman") or die (mysqli_error($koneksi));

// if (isset($_GET["card_simpan"])) {

//   $get_data=$_GET["id_card"];
...
<div class="col-md-3 text-center" id="cart_shop">
  <a href="javascript:void(0)" style="font-size: 38px; float: right;height: 40px; width: 40px; text-align: center;line-height: 40px; color: red;opacity: 1;" class="tutup">&times;</a> <br>
  <h2 class="modal-title" style="color: rgb(36,166,157); font-size: 20px;margin-top: 20px; text-align: center;">List Belanja</h2> <br>
  <h2 class="modal-title" style="color: rgb(172,41,38); font-size: 30px;margin-top: 20px; text-align: center; text-shadow: 2px 2px 5px rgb(0,0,0,0.1); font-family: forte;"><img src="../master_shop/png/toko.png" style="height: 30px;"><br> Keranjang Belanja<br> Kosong</h2>
</div>
...
<div class="jumbotron text-center">
  ...
  <form action="" method="post" id="posisi">
    <select class="from-control" id="kategori" style="color:white; border-bottom:15px solid red; background-color: aqua;">
      <option value="" disabled selected>Kategori Barang / All Prodak </option>
      <option style="color: red;">All Produk</option>
      ...
      <?php 
      $query= mysqli_query($koneksi,"SELECT nama_kategori FROM add_kategori");
      while ($data_barang=mysqli_fetch_assoc($query)) :?>
       <option><?= $data_barang["nama_kategori"]; ?></option>
     <?php endwhile; ?>
   </select>       
 </form> 
  ...
  <div class="container-fluid">
    <div class="row" style="float: left;padding: 0;">
      <?php while ($row=mysqli_fetch_assoc($result)) : ?>
       <div class="col-lg-3 text-left " style="background:linear-gradient(rgb(1,220,245,0.2), white); margin-bottom: 4px;">
        <div class="card">
          <div class="card-image waves-effect waves-block waves-light">
            <p style="color:rgb(1,1,100);  font-weight: bold; width: 100%; background:rgb(255,255,255); box-shadow: none;" class="btn btn-danger"><?php echo $row["nama_barang"]; ?> </p>
          ...
          <div class="card-content">
           ...
           <a href="" style="font-weight: bold; text-align: right;"><i class="pe-7s-cash"></i> Rp. <?php echo $row["harga_barang"]; ?></a>
         </div>
    ...
    <div class="col-md-4">
      <div class="card" style="height: 400px;">
        <div class="card-image waves-effect waves-block waves-light" id="card1">
          <img src="gambar/images.png" style="height: 300px;width: 100%; " ></div>
          <div class="card-content">
          ...
          <div class="card-reveal">
            ...
            <p style="color: rgb(0,0,0,0.6);">Lorem ipsum dolor sit amet, consectetur adipisicing elit, seddoeiusmod
              tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
              quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
              consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
              cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non
      ...
      <div class="col-md-4 ">
        <div class="card" style="height: 400px;">
          ...
          <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Promo Akhir Tahun<i class="material-icons flaticon-menu right"></i></span>
            <p><a href="">This Link Barang</a></p>
          </div>
      ...
      <div class="col-md-4">
        <div class="card" style="height: 400px;">
          ...
          <div class="card-reveal">
           <span class="card-title grey-text text-darken-4"><i class="material-icons right">Close</i></span>
           <p style="color: rgb(0,0,0,0.4);">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed doeiusmod
           </p>
         </div> 
       </div>
     </div>
